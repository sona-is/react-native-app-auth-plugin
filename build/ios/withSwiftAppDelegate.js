...
exports.withReactNativeAppAuthSwiftAppDelegate = void 0;
 ...
 */
const withReactNativeAppAuthSwiftAppDelegate = (config) => {
    return (0, config_plugins_1.withAppDelegate)(config, (config) => {
        ...
        if (!contents.includes('authorizationFlowManagerDelegate')) {
            ...
            if (classRegex.test(contents)) {
                contents = contents.replace(classRegex, '$1\n  public weak var authorizationFlowManagerDelegate: RNAppAuthAuthorizationFlowManagerDelegate?\n');
            }
        }
...
`;
                    contents = contents.replace(appDelegateMatch[0], appDelegateMatch[1] + newMethod + appDelegateMatch[2]);
                }
            }
        }
        ...
        if (!contents.includes('resumeExternalUserAgentFlow(with: userActivity.webpageURL)')) {
            ...
            if (continueUserActivityRegex.test(contents)) {
                ...
                contents = contents.replace(continueUserActivityRegex, `$1
...
exports.withReactNativeAppAuthSwiftAppDelegate = withReactNativeAppAuthSwiftAppDelegate;
